...
<br>
<img src = "https://github.com/lilandracunha/bootcamps-and-foundations/blob/main/bootcamps/dio-microsoft-azure-ai-fundamentals/lab04_cognitiveSearch/assets/selectAISearchResource.png" align = "center"/>
<br>
...
<img src = "https://github.com/lilandracunha/bootcamps-and-foundations/blob/main/bootcamps/dio-microsoft-azure-ai-fundamentals/lab04_cognitiveSearch/assets/selectStorageAccounts.png" align = "center"/> 
...
<img src = "https://github.com/lilandracunha/bootcamps-and-foundations/blob/main/bootcamps/dio-microsoft-azure-ai-fundamentals/lab04_cognitiveSearch/assets/storageAccountView.png" align = "center"/>

5. Altere para ```Enabled``` a opção "<i>Allow Blob anonymous access</i>" e clique em "<i>Save</i>". <br>
<img src = "https://github.com/lilandracunha/bootcamps-and-foundations/blob/main/bootcamps/dio-microsoft-azure-ai-fundamentals/lab04_cognitiveSearch/assets/enableAllowBlob.png" align = "center"/>
...
<img src = "https://github.com/lilandracunha/bootcamps-and-foundations/blob/main/bootcamps/dio-microsoft-azure-ai-fundamentals/lab04_cognitiveSearch/assets/selectContainers.png" align = "center"/>
...
2. Na criação do <i>container</i>, clique em "<i>+ Container</i>" e adicione as seguintes informações: 
  ...
  <img src = "https://github.com/lilandracunha/bootcamps-and-foundations/blob/main/bootcamps/dio-microsoft-azure-ai-fundamentals/lab04_cognitiveSearch/assets/newContainer.png" align = "center"/>
...
<img src = "https://github.com/lilandracunha/bootcamps-and-foundations/blob/main/bootcamps/dio-microsoft-azure-ai-fundamentals/lab04_cognitiveSearch/assets/uploadReviews.png" align = "center"/>
...
<img src = "https://github.com/lilandracunha/bootcamps-and-foundations/blob/main/bootcamps/dio-microsoft-azure-ai-fundamentals/lab04_cognitiveSearch/assets/aiSearch.png" align = "center"/>

2. Selecione o recurso criado para o AI Search e clique em "<i>Import data</i>": <br>
<img src = "https://github.com/lilandracunha/bootcamps-and-foundations/blob/main/bootcamps/dio-microsoft-azure-ai-fundamentals/lab04_cognitiveSearch/assets/importData.png" align = "center"/>
...
6. Em <i><b>Add enrichments</b></i> preencha os seguintes campos:
  ...
  > <br><br>
  > <img src = "https://github.com/lilandracunha/bootcamps-and-foundations/blob/main/bootcamps/dio-microsoft-azure-ai-fundamentals/lab04_cognitiveSearch/assets/chooseConnection.png" aling = "center"/>
  > <br><br>
...
<img src = "https://github.com/lilandracunha/bootcamps-and-foundations/blob/main/bootcamps/dio-microsoft-azure-ai-fundamentals/lab04_cognitiveSearch/assets/selectIndexers.png" aling = "center"/>

13. Na tela apresentada, selecione o indexador ```coffee-indexer```: <br>
<img src = "https://github.com/lilandracunha/bootcamps-and-foundations/blob/main/bootcamps/dio-microsoft-azure-ai-fundamentals/lab04_cognitiveSearch/assets/coffeeIndexer.png" aling = "center"/>
...
<img src = "https://github.com/lilandracunha/bootcamps-and-foundations/blob/main/bootcamps/dio-microsoft-azure-ai-fundamentals/lab04_cognitiveSearch/assets/searchExplorer.png" aling = "center"/>
...
3. A primeira consulta que iremos executar visa retornar um JSON com todos os documentos no index, incluindo o campo <b><i>@odata.count</i></b> que traz a contagem total destes documentos. Para exibir tal retorno, no campo <b><i>JSON query editor</i></b>, inclua a consulta a seguir e clique em "<b><i>Search</i></b>": 
  ...
  <img src = "https://github.com/lilandracunha/bootcamps-and-foundations/blob/main/bootcamps/dio-microsoft-azure-ai-fundamentals/lab04_cognitiveSearch/assets/searchCount.png" aling = "center"/>
...
4. Após receber o retorno com todos os documentos, iremos filtrar por local. Para isto, copie a seguinte consulta no <b><i>JSON query editor</i></b> e clique em "<b><i>Search</i></b>": 
  ...
  <img src = "https://github.com/lilandracunha/bootcamps-and-foundations/blob/main/bootcamps/dio-microsoft-azure-ai-fundamentals/lab04_cognitiveSearch/assets/searchChicago.png" aling = "center"/>
...
5. Como última consulta, iremos filtrar as avaliações negativas, copiando a consulta abaixo no <b><i>JSON query editor</i></b> e clicando em "<b><i>Search</i></b>":
  ...
  <img src = "https://github.com/lilandracunha/bootcamps-and-foundations/blob/main/bootcamps/dio-microsoft-azure-ai-fundamentals/lab04_cognitiveSearch/assets/searchNegative.png" aling = "center"/>
